...
class UserController extends Controller
{
  ...
  */
  public function __construct(UserRepository $userRepository)
  {
    ...
    $this->middleware('auth:admin', ['only' => ['editAdmin', 'updateAdmin', 'indexAdmin', 'destroyAdmin', 'unban']]);
    $this->middleware('auth:web' , ['except' => ['editAdmin', 'updateAdmin', 'indexAdmin', 'destroyAdmin', 'unban']]);
